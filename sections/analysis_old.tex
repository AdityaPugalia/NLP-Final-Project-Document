...
full-precision counterpart without any architectural change. One plausible explanation is \textbf{quantisation noise as implicit regularisation}: the rounding errors introduced by 8-bit arithmetic act as a stochastic perturbation of the gradient, similar in spirit to dropout or weight noise.
